# script: 93-complexity_models
# description: complexity model fitting for the Big O complexity analysis
#   module. defines the candidate model set and the fitting routine that selects
#   the best model by adjusted R².
#
