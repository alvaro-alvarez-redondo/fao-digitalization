# script: 95-benchmark_definitions
# description: benchmark descriptor catalogue for the Big O complexity analysis
#   module. all benchmark closures are self-contained: they capture their input
#   via the fn_factory pattern and perform no I/O or global state mutations.
#
# depends on: 92-synthetic_data.R  (make_wide_dt, make_long_dt,
