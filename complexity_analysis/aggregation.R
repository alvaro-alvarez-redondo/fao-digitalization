# module: aggregation
# description: benchmark execution and results aggregation for the complexity
#   analysis module. iterates over all benchmark definitions, times each one,
#   fits the complexity model, and aggregates the results into a single
#   structured list.
#
# depends on: model_fitting.R  (fit_complexity_model)
#             timing_engine.R  (run_benchmark, summarise_benchmark)
