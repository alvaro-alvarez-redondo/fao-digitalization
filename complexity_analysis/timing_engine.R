# complexity_analysis/timing_engine.R
# description: timing engine for the Big O complexity analysis module.
...
#   (summarise_benchmark). supports warmup runs and noise reduction through
...
#' @param progressor optional progressor function. when supplied, one tick is
#'   emitted per input size and per-size message() output is suppressed.
...
#' @return data.table with per-n summary statistics sorted by n.
