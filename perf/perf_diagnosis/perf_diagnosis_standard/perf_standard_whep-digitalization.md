...
| perf_2-postpro_pipeline | 3               | aggregate_standardized_rows (O(n)) | O(n)                | aggregate_standardized_rows (O(n), score 0.3359) | 8.4%          |
...
| perf_2-postpro_pipeline | 8.4%          | 0.2004           | O(n)                | aggregate_standardized_rows (61.7%) | aggregate_standardized_rows (0.3359) | 0.0%                 | 66.7%                 | 0                    |
...
| perf_2-postpro_pipeline | aggregate_standardized_rows (61.7%) | aggregate_standardized_rows (O(n)) | aggregate_standardized_rows (0.3359) | P2       | 0.2004           | 0                  | 2                   |
...
| 4    | aggregate_standardized_rows | perf_2-postpro_pipeline | O(n)       | 0.3359          | 61.7%        | very high  | 0.11549       | P2       | high_impact                                     | grouping across repeated keys increases hash/scan c~ |
...
| 9    | apply_standardize_rules     | perf_2-postpro_pipeline | O(n)       | 0.2098          | 25.2%        | very high  | 0.33129       | P2       | high_volatility                                 | grouping across repeated keys increases hash/scan c~ |
| 10   | extract_aggregated_rows     | perf_2-postpro_pipeline | O(n)       | 0.1659          | 13.1%        | very high  | 0.40185       | P2       | high_volatility                                 | grouping across repeated keys increases hash/scan c~ |
...
| aggregate_standardized_rows | perf_2-postpro_pipeline | O(n)       | 0.3359          | 61.7%        | large runtime share; sharp growth jump (max 10.98x) | up to 61.7% stage runtime |
...
| apply_standardize_rules | perf_2-postpro_pipeline | O(n)       | 0.2098          | 25.2%        | unstable repeated timings; sharp growth jump (max 2~ | up to 25.2% stage runtime |
| extract_aggregated_rows | perf_2-postpro_pipeline | O(n)       | 0.1659          | 13.1%        | unstable repeated timings; sharp growth jump (max 1~ | up to 13.1% stage runtime |
```
